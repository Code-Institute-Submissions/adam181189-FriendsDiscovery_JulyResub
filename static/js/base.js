document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function stripeElements() {
        stripe = Stripe('pk_test_51IrJGOBBQ6etgiwPGrLa5gj7zQEPEezFLzgkZRK1VLQu4ggGbrx2YvsMRPaC3vmIy5aq9v8oCdxk4w9hf0agv5U6002oRBFZ7J');
    ...
    function displayError(event) {
        ...
        if (event.error) {
            ...
            alert("Your subscription payment was not successful. " + event.error + ". Please re-try your payment.");
    ...
    function createPaymentMethod({ card }) {
      ...
      let billingName = document.getElementById("username").value;
